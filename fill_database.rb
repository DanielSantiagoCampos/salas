...
Reservation.create(start_date: Time.new(2023, 05, 18, 12, 15), end_date: Time.new(2023, 05, 18, 13, 15), range: 1, user_id: 3, tool_id: 1)
Reservation.create(start_date: Time.new(2023, 05, 18, 14, 15), end_date: Time.new(2023, 05, 18, 16, 15), range: 2, user_id: 3, tool_id: 1)

Reservation.create(start_date: Time.new(2023, 05, 19, 14, 15), end_date: Time.new(2023, 05, 18, 15, 15), range: 1, user_id: 4, tool_id: 3)
Reservation.create(start_date: Time.new(2023, 05, 19, 16, 15), end_date: Time.new(2023, 05, 18, 18, 15), range: 2, user_id: 4, tool_id: 3)

Reservation.create(start_date: Time.new(2023, 05, 22, 12, 15), end_date: Time.new(2023, 05, 18, 13, 15), range: 1, user_id: 3, tool_id: 4)
Reservation.create(start_date: Time.new(2023, 05, 23, 14, 15), end_date: Time.new(2023, 05, 18, 16, 15), range: 2, user_id: 3, tool_id: 4)

Reservation.create(start_date: Time.new(2023, 05, 24, 14, 15), end_date: Time.new(2023, 05, 18, 15, 15), range: 1, user_id: 4, tool_id: 5)
Reservation.create(start_date: Time.new(2023, 05, 25, 16, 15), end_date: Time.new(2023, 05, 18, 18, 15), range: 2, user_id: 4, tool_id: 5)
